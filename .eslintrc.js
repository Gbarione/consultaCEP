module.exports = {
	...
	rules: {
		...
		"id-length": ["error", { min: 3, max: 30, exceptionPatterns: ["[A-Z_]+", "id"] }],
		...
		"@typescript-eslint/naming-convention": [
			...
			},
			{
				selector: "variable",
				types: ["boolean"],
				format: ["PascalCase"], // prefix is trimmed before format is validated, thus PascalCase must be used to allow variables such as isEnabled
